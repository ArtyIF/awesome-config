...
theme.tasklist_bg_normal = string.sub(theme.bg_focus, 1, 7) .. "7F"
theme.tasklist_bg_focus = string.sub(theme.bg_focus, 1, 7)
theme.tasklist_bg_minimize = string.sub(theme.bg_focus, 1, 7) .. "3F"
